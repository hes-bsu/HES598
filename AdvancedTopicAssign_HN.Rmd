...
folder.url <- "https://drive.google.com/drive/folders/1w2Bu9vCjRoHD6f52nMIXCmmC723OOCR7"
folder <- drive_get(as_id(folder.url))
files <- drive_ls(folder)
drive_download("Dummy_Survey.xlsx", path = "Documents/Boise State/Spring 2020/HES 598 R/Project/Data")
...
```{r Benchmarking for Post-Stratification}
...
# Final Product
I attempted to create plots to compare sample to population and the effects of post-stratification on preference for sagebrush, but kept reaching an error in gzfile(file,wb). 
