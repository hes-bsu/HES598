...
Some familiarity with the R statistical environment is helpful, but not necessary. My goal is to foster an environment where we are all learning from each other and sharing the tips and tricks that help us along the way. If you want to start learning a few of the basics, the **Resources** tab has some background information to get you started. 
