...
Students completing this course should be able to:
 ...
 - Compare and contrast common types of spatial data
 - Develop workflows to: 
    - Import, export, and visualize spatial data in R
    - Extract spatial data for use in statistical analyses
    - Generate new spatial data based on statistical analyses
 - Write functions to automate and parallelize repetitive tasks
 - Use benchmarking to identify computationally efficient approaches for data-intensive tasks 
