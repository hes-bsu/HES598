...
Create raster from 'counties_AE' spatial object
...
#isolate Ada & Elmore counties pologons from Idaho county shape file
studyCounties <- subset(idaho_counties, NAME == "Ada" | NAME == "Elmore")

#bring in spatial coordiantes of 'ABS' locals
coords <- artBurrow_spatialTable
...
```{r gdistance_costDistance, include = TRUE}
elevCounties_leastCost <- costDistance(elevCounties_tran_geocorr, artBurrow_spdf)
