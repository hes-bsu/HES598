...
artBurrow_utm <- read_excel("Belthoff Burrows - UTMs_revised.xlsx")

#from artificial burrow locaiton data_frame create spatial table 
artBurrow_spatialTable <- artBurrow_utm %>% st_as_sf(coords = c("NORTHING", "EASTING"), crs = 4326)


artBurrow <- st_geometry(artBurrow_spatialTable) #creates burrow location points based on 'artBurrow_spatialTable'
#artBurrow <- st_set_crs(artBurrow, 4326)
#artBurrow_ID <- rasterize(artBurrow, elevIdaho)
...
###
#Incorporate artificial burrow locations onto Idaho Elevation map
###
