...
My thesis research aims to quantify the degree of landscape change on the landscape. The study site of interest is the Rupununi savanna-forest bounday located on the Southwest portion of Guyana (South America). In order to quantify change, I have done a preliminary study looking at landscape metrics using FRAGSTATS software found here: https://www.umass.edu/landeco/research/fragstats/fragstats.html.
My chosen Advanced Topic for this course is: Landscape Metrics and Raster Data. Upon learning that the landscape metrics are available in R through FRAGSTATS, I will investigate how to use this package and evaluate the are pros and cons to FRAGSTATS standalone software vs FRAGSTATS in R.
My goal for this assignment is to quanitify landscape metrics in s subset of the study region to learn more about the packages and how to use the software in R. 
...
## SDMToolsl()#limited FRAGSTATS package


## landscapemetrics() More recent FRAGSTATS package

#load your data - which datasets do you need?
##Dadanawa raster file. will use the planetLabs file OR the SUA classification of year 2015
