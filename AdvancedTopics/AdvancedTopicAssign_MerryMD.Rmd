...
#lapply(files$id, function(x) drive_download(as_id(x), path = "/path/to/your/local/directory/not/class repo/" overwrite = TRUE)) #replace the path with a folder on your computer outside of the repo directory
