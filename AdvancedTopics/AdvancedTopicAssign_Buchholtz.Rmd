...
```{r}
#Libraries used: The main package I use for analysis in this project is spatstat. This is a basic spatial stats package with good documentation, and a focus on simulating and analyzing point patterns. A basic list of its functions and capabilities can be found here: https://spatstat.org/resources/spatstatQuickref.pdf

#Other packages I make use of include:
#sf
...
#to do this, I'll create a plot with points within it, and then use spatial tests to investigate point patterns. Finally, I'll bring in sample data I've made of points near my study sites, and use the tests on this data as well. 

###The simulated data will be:
#Points in a rectangular window 
#points in a circular window
...
#I will test the data to see if it is clustered or regular 
#-->I would like to see if I can identify clusters themselves, and have a data output showing me which sites are clustered with each other. Maybe I'll use K means to do this??


#Check the outcomes? How will you know if your steps worked?
#One way I could test my outcomes is to map the points
#If I can identify distinct clusters, I could use colors or symbols to show which points are assigned to which clusters.
