...
```{r}
#Libraries used: spatstat
#This is a basic spatial stats package with good documentation, and a focus on simulating and analyzing
#point patterns. A basic list of its functions and capabilities can be found here: https://spatstat.org/resources/spatstatQuickref.pdf
