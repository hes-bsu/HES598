...
#Then we use the function geoCorrection to divide by the distance between cells. Values in the matrix has distortion, West-East connections are longer at the equator and become shorter towards the poles, as the meridians approach each other. Type "c" can correct both types of distortion.
