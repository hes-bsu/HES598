...
### I renamed the originalS06W080.hgt to S06W080.hgt
elev=raster::raster("C:/Users/Sandra/Desktop/R files/Stats/RMarkdownAssignment_Sandra/datatemp/S06W080.hgt")
elev
...
# I used sp to projecting my csv originaldata_sample:

elev=raster::raster("C:/Users/Sandra/Desktop/R files/Stats/RMarkdownAssignment_Sandra/datatemp/S06W080.hgt")
elev

proj4string(elev)
proj4string(data_sample)

elevp <- crs(elev)

elevp="+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0"
datap=SpatialPointsDataFrame(originaldata_sample[,c(1,2)],data=originaldata_sample, proj4string=CRS(elevp))
