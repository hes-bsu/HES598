...
L8_snow<-sum(L8_snow, na.rm = TRUE)

L8_fsca<-L8_snow/area_L8


area_starfm = starfm_jan29@nrows*starfm_jan29@ncols

starfm_snow<-as.vector(starfm_binary, mode = 'numeric')
starfm_snow<-sum(starfm_snow, na.rm = TRUE)

starfm_fsca<-starfm_snow/area_starfm


## Create a confusion matrix to evaluate the performance of the model against the Landsat data

landsat_factor<-as.factor(landsat_binary)
starfm_factor<-as.factor(starfm_binary)

confusionMatrix(starfm_binary,landsat_binary, positive = 1)
